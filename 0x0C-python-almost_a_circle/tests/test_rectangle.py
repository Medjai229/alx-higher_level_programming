...
class Test_Rectangle_stdout(unittest.TestCase):
    ...
    def capture_output(rect, method):
        ...
        Args:
        -   rect (Rectangle): The Rectangle object to be printed.
    ...
    def test_str_method_print_width_height(self):
        r = Rectangle(4, 6)
        capture = Test_Rectangle_stdout.capture_output(r, "print")
    ...
    def test_display_width_height(self):
        ...
        capture = Test_Rectangle_stdout.capture_output(r, "display")
        self.assertEqual("##\n##\n##\n", capture.getvalue())
